...
import GameFinishedModal from '../../components/GameFinshedModal';
...
export class GameScreen extends Component {
    ...
    GameStatusText() {
        ...
        return status === GameStatus.WON? "You Won":"You Lose";
    }
    ...
    render() {
        ...
        return (
            <View style={[styles.game, ...(isLandscape ? [styles.gameLandscape] : [])]}>
                ...
                {this.isGameEnded()&&<GameFinishedModal status={this.props.game.game.status}  statusText={this.GameStatusText()} restart={this.onGameButtonPressed} requestClose={this.onMenuButtonPressed}/>}
